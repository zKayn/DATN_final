...
export default function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      if (ordersResponse.success && customersResponse.success && productsResponse.success) {
        setStats({
          totalRevenue: ordersResponse.data.totalRevenue || 0,
          totalOrders: ordersResponse.data.totalOrders || 0,
          totalCustomers: customersResponse.data.totalCustomers || 0,
          totalProducts: productsResponse.data.data?.length || productsResponse.data.length || 0,
          pendingOrders: ordersResponse.data.pendingOrders || 0,
